# @file
# Script to Build SurfaceDuo Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SurfaceDuoPkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('SurfaceDuo', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("SurfaceDuoPkg/SurfaceDuo.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SurfaceDuo", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SurfaceDuoPkg/SurfaceDuo.dsc", "Platform Hardcoded")
