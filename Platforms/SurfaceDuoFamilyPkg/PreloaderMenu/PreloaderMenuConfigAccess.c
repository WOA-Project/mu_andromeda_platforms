/** @file
  HiiConfigAccess definitions for PreloaderMenu.
...
/**
  ...
  PRELOADER_MENU_HACK structure from the target driver.
...
{
  EFI_STATUS              Status;
  PRELOADER_MENU_UI_CONTROLS  PreloaderMenuUiControls;
  ...
  PreloaderMenuUiControls.PostSecurityLocks = IsPostReadyToBoot ();
  ...
  Status = mHiiConfigRouting->BlockToConfig (
                                mHiiConfigRouting,
                                Request,
                                (UINT8 *)&PreloaderMenuUiControls,
                                sizeof (PreloaderMenuUiControls),
                                Results,
                                Progress
                                );
  ...
  )
{
  ...
  *Progress = Request;
  ...
  if (HiiIsConfigHdrMatch (Request, &gMuPreloaderMenuConfigFormSetGuid, L"PreloaderMenuUiControls")) {
    GetPreloaderMenuUiControls (Request, Progress, Results);
  } else {
