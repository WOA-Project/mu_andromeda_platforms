...
cat ./BootShim/BootShim.bin ./Build/SurfaceDuoPkg/RELEASE_CLANG38/FV/SM8150_EFI.fd > ./ImageResources/Epsilon/bootpayload.bin
cat ./ImageResources/Epsilon/patchedkernel ./Build/SurfaceDuoPkg/RELEASE_CLANG38/FV/SM8150_EFI.fd > ./ImageResources/Epsilon/dualbootbootpayload.bin
