...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEVEx[] = {
...
#endif
    {"RAM Partition",     0xAEB00000, 0x0A800000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    /* DDR Bank 0 End */
    /* Carveout Region (0xB9300000 -> 0xB9900000, size 0x00600000) */
    /* DDR Bank 1 Start */
    {"RAM Partition",     0xB9900000, 0x01E00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    /* DDR Bank 1 End */
    /* Carveout Region (0xBB700000 -> 0xC0000000, size 0x04900000) */
    /* DDR Bank 2 Start */
    ...
    {"Kernel",            0xE3402000, 0x10000000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN},
    {"RAM Partition",     0xF3402000, 0x4CBFE000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorDVEx[] = {
    ...
    /* DDR Bank 1 Start */
    {"RAM Partition",     0xB9D00000, 0x01E00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    /* DDR Bank 1 End */
